...
<link href="{{asset('assets/css/bootstrap.css?v=2.0')}}" rel="stylesheet" type="text/css"/>

<!-- Font awesome 5 -->
<link href="{{asset('assets/fonts/fontawesome/css/all.min.css?v=2.0')}}" type="text/css" rel="stylesheet">

<!-- custom style -->
<link href="{{asset('assets/css/ui.css?v=2.0')}}" rel="stylesheet" type="text/css"/>
<link href="{{asset('assets/css/responsive.css?v=2.0')}}" rel="stylesheet" type="text/css" />

<!-- custom javascript -->
<script src="{{asset('assets/js/script.js?v=2.0')}}" type="text/javascript"></script>

</head>
<body>

<!-- REMOVE FOLLOWING LINK -->
<a href="http://bootstrap-ecommerce.com/page-themes.html" class="btn btn-dark rounded-pill" style="font-size:13px; z-index:100; position: fixed; bottom:10px; right:10px;">Download theme</a>
<!-- REMOVE  //END -->
		...
		<div class="row align-items-center">
			<div class="col-xl-2 col-lg-3 col-md-12">
				<a href="http://bootstrap-ecommerce.com" class="brand-wrap">
					<img class="logo" src="{{asset('assets/images/logo.png?v=2.0')}}">
				</a> <!-- brand-wrap.// -->
			</div>
